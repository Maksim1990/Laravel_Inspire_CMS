    ...
    <div class="w3-main" id="main">
        <div class="w3-main" id="main-sub">
            <div class=" col-xs-7 col-sm-1" id="mainClick">
                ...
                <p class="btnShowSidebar" style="margin-top: -5px;" onclick="w3_open()"><span>&#9776;</span></p>
                <p class="tooltip_menu"><span><i class='fa fa-users' aria-hidden='true'></i></span>
                ...
                <p class="tooltip_menu"><span><i class='fa fa-bookmark' aria-hidden='true'></i></span>
                    <span class="tooltiptext">
                               <a href="#" >Profile</a>
                                <a href="#" >CSS</a>
                                <a href="#" >Settings</a>
