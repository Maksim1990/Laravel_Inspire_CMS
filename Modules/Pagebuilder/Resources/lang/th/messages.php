...
return [
    ...
    'create_block' => 'สร้างบล็อก',
    'not_active_blocks' => 'บล็อกที่ไม่ได้ใช้งาน',
    'active_blocks' => 'บล็อคที่ใช้งานอยู่',
    'info_1' => 'หากต้องการเปลี่ยนเนื้อหาบล็อกให้วางเมาส์ไว้บนบล็อกแล้วคลิกปุ่มเมาส์ขวา',
    'info_2' => 'เพื่อที่จะเปลี่ยนลำดับการบล็อกให้วางบนบล็อกและลากไปยังตำแหน่งใหม่',
    'editor_settings' => 'การตั้งค่า',
    'custom_css' => 'CSS กำหนดเอง',
    'customize_footer' => 'กำหนดส่วนท้ายของเว็บไซต์',
    'customize_google_and_form' => 'กำหนดค่าการปิดกั้นฟอร์ม Google และที่ติดต่อ',
    'change_blocks_order' => 'เปลี่ยนคำสั่งบล็อก',
    'block_info_order' => 'โปรดลากบล็อคเพื่อเปลี่ยนลำดับการบล็อก<br>
                เมื่อต้องการแก้ไข ID บล็อกให้คลิกหนึ่งครั้งบนบล็อก<br>
                ในการปิดใช้งานบล็อกให้ลากไปทางด้านซ้ายเพื่อ <b> \'บล็อกที่ไม่ได้ใช้งาน\' </b><br>',
];