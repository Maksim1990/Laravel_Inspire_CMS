<div class="row maintab">
    <div class="col-sm-12 col-lg-12 col-xs-12">
        <div class="col-sm-8 col-lg-8 col-xs-12">
            ...
            @php
                $strDisplay="none";
                if(!empty($blockBackgroundFooter) && $blockBackgroundFooter->background_type=='color'){
                 $strChecked="block";
                }
            @endphp
                ...
                <div class="col-sm-5 col-xs-12">
                    <div class="form-group">
                        <p>
                            ...
                            @php
                                $strColor="";
                                if(!empty($blockBackgroundFooter) && !empty($strColor=$blockBackgroundFooter->color)){
                                $strColor=$blockBackgroundFooter->color;
                                }
                            @endphp
            ...
            <div class="col-sm-12 col-lg-12 col-xs-12">
                ...
                <div class="col-sm-1 col-xs-12">
                    <div class="form-group" style="margin-top: 15px;">
                        @php
                            $strChecked="";
                            if(!empty($blockBackgroundFooter) && $blockBackgroundFooter->background_type=='image'){
                             $strChecked="checked";
                            }
                        @endphp
            ...
            <div class="col-sm-12 col-lg-12 col-xs-12" id="background_image_block" style="display:{{$strDisplay}};">
                ...
                <div class="col-sm-7 col-xs-12">
                    <div class="form-group" style="margin-top: 15px;">
                        ...
                        @php
                            ...
                            if(!empty($blockBackgroundFooter) && !empty($blockBackgroundFooter->image_path)){
                ...
                <div class="col-sm-5 col-xs-12">
                    <div id="used_block_image">
                        @if(!empty($blockBackgroundFooter) && !empty($blockBackgroundFooter->image_path))
                            <img src="{{custom_asset("storage/".$blockBackgroundFooter->image_path)}}"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if(!empty($blockBackgroundFooter) && Auth::id()==$blockBackgroundFooter->user_id)
                    {!! Form::close() !!}
