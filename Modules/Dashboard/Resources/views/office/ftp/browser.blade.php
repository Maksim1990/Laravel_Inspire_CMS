    ...
    <div class="row">
        <div class="col-sm-12 col-md-10  col-xs-12">
            <div class="col-sm-12 col-md-12  col-xs-12">
                <h3 class="title">@lang('dashboard::messages.ftp_browser')</h3>
                ...
                <div class="insp_buttons">
                    ...
                    <a href="#" id="close_all" class="btn btn-info">@lang('dashboard::messages.close_all_nodes')</a>
                </div>
                <div id="jstree"></div>
            ...
            $('#jstree').on("changed.jstree", function (e, data) {
                ...
                if(fileType==='folder'){
                    ...
                    new Noty({
                        type: 'error',
                        layout: 'bottomLeft',
                        text: '{{trans('dashboard::messages.simple_file')}}'
                    }).show();
                }
