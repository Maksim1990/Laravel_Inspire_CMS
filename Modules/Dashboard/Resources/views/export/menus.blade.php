...
@section('General')
    <div class="row">
        <div class="col-sm-12 col-md-10  col-xs-12">
            <h3 class="title">
                @lang('dashboard::messages.export_menus')
            </h3>
            ...
            <div class="col-sm-12 col-md-8  col-xs-12">
                {!! Form::open(['method'=>'POST','action'=>['\Modules\Dashboard\Http\Controllers\ExcelController@exportMenusFile','id'=>Auth::id()], 'files'=>true])!!}
                ...
                <div class="group-form col-sm-12">
                    ...
                    @foreach($arrMenuLangs as $key=>$strLang)
